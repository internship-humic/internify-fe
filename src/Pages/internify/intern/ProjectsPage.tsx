...
export default function ProjectsPage() {
  ...
  const renderContent = () => {
    ...
    if (projects.length === 0) {
      return (
        <div className="flex w-full flex-col items-center justify-center py-2 gap-3 mt-19">
          <img className="w-[440px]" src={TeamPana} alt="" />
          <p className="text-[13px] text-font-shade">Kamu belum tergabung ke projek apapun</p>
        </div>
      );
    }
